...
import net.com.burntland.procedures.LybbPlayerFinishesUsingItemProcedure;

public class LybbItem extends Item {
	public LybbItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		LybbPlayerFinishesUsingItemProcedure.execute(entity);
		return retval;
	}
}
